%chapter = (
     ...
     'sec1' => {
          ...
          'labels' => {
                "1.1A" => "A. Recognizing statements",
                "1.1B" => "B. True or False?",
                "1.1C" => "C. Valid or Invalid?",
                "1.1D" => "D. Soundness",
          },
          'counts' => {
                "1.1A" => "30",
     ...
     'sec2' => {
          'title'  => "Forms and Validity",
          'labels' => {
                "1.2A" => "A. True or False?",
     ...
     'sec4' => {
          ...
          'labels' => {
                "1.4A" => "A. Matching",
                "1.4B" => "B. True or False",
                "1.4C" => "C. Valid or Invalid? Strong or Weak?",
                "1.4D" => "D. Cogency",
          },
          'counts' => {
                "1.4A" => "15",

%chapter = (
     'chapnum' => 4,
     'title'  =>"Chapter 4 -- Informal Fallacies",
     'sections' => "1 2 3 ",
     'sec1' => {
          'title'  => "Fallacies Involving Irrelevant Premises",
          'labels' => {
                "4.1A" => "A. Formal and Informal Fallacies",
                "4.1B" => "B. More Formal and Informal Fallacies",
          },
          'counts' => {
                "4.1A" => "30",
                "4.1B" => "25",
     ...
     'sec2' => {
          'title'  => "Fallacies Involving Ambiguity",
          'labels' => {
                "4.2A" => "A. Fallacies Involving Ambiguity",
     ...
     'sec3' => {
          'title'  => "Fallacies Involving Unwarranted Assumptions",
          'labels' => {
                "4.3A" => "A. Identifying Fallacies",
                "4.3B" => "B. More Identifying Fallacies",
          },
          'counts' => {
                "4.3A" => "30",
                "4.3B" => "34",
